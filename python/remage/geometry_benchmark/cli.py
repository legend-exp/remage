...
/RMG/Output/ActivateOutputScheme Benchmark
/RMG/Output/FileName {output_file}
/run/initialize

/RMG/Generator/Select Benchmark

/RMG/Generator/Benchmark/IncrementX {increment_x} mm
/RMG/Generator/Benchmark/IncrementY {increment_y} mm
/RMG/Generator/Benchmark/IncrementZ {increment_z} mm
...
def remage_geometry_benchmark_cli() -> int:
