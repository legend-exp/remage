...
output_lh5_jag="${4/.mac/-pproc.lh5}"

output_dump_h5="${output_h5}.ls"
output_dump_lh5="${output_lh5}.ls"
output_dump_lh5_jag="${output_lh5_jag}.ls"

output_exp_h5="dumps/${4/.mac/.hdf5.ls}"
output_exp_lh5="dumps/${4/.mac/.lh5.ls}"
output_exp_lh5_jag="dumps/${4/.mac/-pproc.lh5.ls}"
...
# convert the HDF file to LH5.
cp "$output_h5" "$output_lh5"
