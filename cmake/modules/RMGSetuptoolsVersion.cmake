...
if(NOT PROG_SETUPTOOLS_SCM)
  ...
  if(NOT EXISTS "${SCM_VENV_DIR}/initialized")
    message(STATUS "initializing venv for setuptools-scm")
  ...
  set(PROG_SETUPTOOLS_SCM ${SCM_VENV_DIR}/bin/python -m setuptools_scm)
else()
  message(STATUS "Found system setuptools-scm: ${PROG_SETUPTOOLS_SCM}")
endif()

# try to get the version from setuptools-scm.
execute_process(
  COMMAND ${PROG_SETUPTOOLS_SCM}
