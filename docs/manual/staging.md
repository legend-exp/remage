...
The initial stage of Geant4 is stage 0 and their index are increased with every
stage transition. In remage, deferral is implemented only for tracks created in
stage 0. Tracks created in stage 1 and above that meet the defer-to-waiting
conditions are processed immediately.
