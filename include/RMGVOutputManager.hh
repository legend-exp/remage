...
class RMGVOutputManager {
  ...
  public:
    ...
    RMGVOutputManager();
    virtual ~RMGVOutputManager() = default;

    RMGVOutputManager           (RMGVOutputManager const&) = delete;
    RMGVOutputManager& operator=(RMGVOutputManager const&) = delete;
    RMGVOutputManager           (RMGVOutputManager&&)      = delete;
    RMGVOutputManager& operator=(RMGVOutputManager&&)      = delete;
