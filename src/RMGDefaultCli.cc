...
void RMGDefaultCli::ParseCliArgs(int argc, char** argv) {
...
void RMGDefaultCli::SetupCli(CLI::App& app) {
...
void RMGDefaultCli::SetupLoggingAndIpc() {
...
void RMGDefaultCli::SetupMacros(RMGManager& manager) {
...
int RMGDefaultCli::RunSimulation(int argc, char** argv) {

  RMGManager manager("remage", argc, argv);

  SetupRuntime(manager);
  SetupMacros(manager);
  SetupOutput(manager);
  SetupGeometry(manager);
