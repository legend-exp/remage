...
MGUIcmdStepLimit::MGUIcmdStepLimit(G4String command_path, G4UImessenger* aMessenger):
...
G4double MGUIcmdStepLimit::GetStepSize(G4String par_string) {
...
G4String MGUIcmdStepLimit::GetParticleName(G4String par_string) {
...
G4String MGUIcmdStepLimit::GetVolumeName(G4String par_string) {
