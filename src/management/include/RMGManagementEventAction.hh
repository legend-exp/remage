...
class RMGManagementEventAction : public G4UserEventAction {
  ...
  inline const RMGVOutputManager* GetConstOutputManager() const {return fOutputManager;}
   ...
   */
  RMGManagementEventActionMessenger* fG4Messenger;

  /**
   * Pointer to the output class. Set via User interface
   */
  RMGVOutputManager* fOutputManager;
