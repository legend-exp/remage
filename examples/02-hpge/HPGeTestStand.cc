...
G4VPhysicalVolume* HPGeTestStand::DefineGeometry() {
  ...
  auto world_l =
      new G4LogicalVolume(world_s, RMGMaterialTable::GetMaterial("LiquidArgon"), "WorldLAr");
  ...
  auto hpge_l =
      new G4LogicalVolume(hpge_s, RMGMaterialTable::GetMaterial("EnrichedGermanium"), "HPGe");
